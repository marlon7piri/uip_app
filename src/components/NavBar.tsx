    ...
    <div className='w-screen'>
      <nav className={`${scroll < 10 ? "nav_container" : "nav_container_bajando"}`}>
        ...
        <ul className="menu">
         ...
         <Link href={'/perfil'} className='text-[18px]  hover:text-blue-900 hover:underline font-semibold transition duration-500'><Tooltip title='Cerrar sesión'><Person style={{ color: 'white' }} /></Tooltip></Link>
